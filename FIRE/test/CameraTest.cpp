...
{
    EXPECT_EQ(cam.GetTransform().Position(), glm::vec3(0.0f, 0.0f, 0.0f));
}

TEST(Standalone_ACamera, CanBeInitializedWithAPosition)
{
    glm::vec3 const camPos(1.0f, 2.0f, 3.0f);
...
{
    glm::vec3 const dummyPos(1.0f, 2.0f, 3.0f);
    glm::vec3 const lookAt(0.0f, 0.0f, 1.0f);
