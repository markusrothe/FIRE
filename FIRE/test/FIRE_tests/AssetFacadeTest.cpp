...
//    assets.SubmitTexture(NAME, width, height, data, numComponents, wrappingMode, filter);
//}
//
...
//
//    assets.SubmitTexture(NAME, width, height, data, numComponents, wrappingMode, filter);
//    ASSERT_ANY_THROW(assets.SubmitTexture(NAME, width, height, data, numComponents, wrappingMode, filter));
//}
//
