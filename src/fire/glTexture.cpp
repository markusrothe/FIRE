    ...
    , m_bound(false)
{
    if(m_textureTarget != GL_NONE)
    {
        ...
        /* TODO:
           ...
           GL_TEXTURE_WRAP_T, GL_REPEAT); glTexParameterf(GL_TEXTURE_2D,
           GL_TEXTURE_MAX_ANISOTROPY, 16); glTexImage2D(GL_TEXTURE_2D, 0,
...
bool GLTexture::Bound() const { return m_bound; }
} // namespace Fire
