...
std::vector<glm::vec3> const& VertexData::GetColors() const { return m_colors; }
...
bool VertexData::IsDirty() const { return m_isDirty; }

void VertexData::ClearDirtyFlag() { SetDirtyFlag(false); }

void VertexData::SetDirtyFlag(bool dirty) { m_isDirty = dirty; }

void VertexData::AddToContainer(
    std::vector<glm::vec3>& container, glm::vec3 const& value)
{
