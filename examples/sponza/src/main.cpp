...
//}
//
//std::vector<FIRE::Renderable> LoadSponzaModel(FIRE::MeshFactory& meshManager, FIRE::MaterialFactory& materialFactory, FIRE::TextureManager& texManager)
//{
